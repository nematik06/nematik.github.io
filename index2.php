...
<head>
	...
	<title>Тестовая страница Nemat.uz</title>
...
<body>
	<div id="wrapper">
		...
		<nav>
			<ul class="top-menu">
				<li class="active"><a style="color:white;" href="/home/">Главная</a></li>
				<li><a href="/about/">О Нас</a></li>
				<li><a href="/services/">Сервисы</a></li>
				<li><a href="/partners/">Партнеры</a></li>
				<li><a href="/customers/">Команда</a></li>
		...
		<section>
			<blockquote>
				...
				<cite>Ахмедов Неъмат, Nemat.uz</cite>
			</blockquote>
			...
			<div class="team-row">
				<figure>
					...
					<figcaption>Ахмедов Неъмат<span>Глава</span></figcaption>
				</figure>
				<figure>
					<img src="images/sample.png" width="96" height="96" alt="">
	...
	<footer>
		<div id="footer">
			...
			<div id="footer-logo">
				...
				<p>Copyright &copy; 2018 Nemat.uz. A <a href="http://pcklab.com">Nemat.uz</a> creation </p>
			</div>
		</div>
	</footer>
</body>
